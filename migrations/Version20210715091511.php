 ...
 */
final class Version20210715091511 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE customer DROP favory');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE customer ADD favory JSON DEFAULT NULL');
    }
}
