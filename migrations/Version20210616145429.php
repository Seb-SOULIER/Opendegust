 ...
 */
final class Version20210616145429 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(45) NOT NULL, parent_id INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE provider (id INT AUTO_INCREMENT NOT NULL, description_id INT DEFAULT NULL, contact_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, registration_at DATETIME NOT NULL, civility INT DEFAULT NULL, lastname VARCHAR(45) DEFAULT NULL, firstname VARCHAR(45) DEFAULT NULL, is_verified TINYINT(1) NOT NULL, company VARCHAR(45) DEFAULT NULL, picture VARCHAR(255) DEFAULT NULL, social_reason VARCHAR(45) DEFAULT NULL, siret INT DEFAULT NULL, vat_number INT DEFAULT NULL, opening JSON DEFAULT NULL, monthly_frequentation INT DEFAULT NULL, other_site JSON DEFAULT NULL, know_us JSON DEFAULT NULL, UNIQUE INDEX UNIQ_92C4739CE7927C74 (email), UNIQUE INDEX UNIQ_92C4739CD9F966B (description_id), UNIQUE INDEX UNIQ_92C4739CE7A1254A (contact_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
