 ...
 */
final class Version20210611074253 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE calendar (id INT AUTO_INCREMENT NOT NULL, offer_variation_id INT NOT NULL, start_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_6EA9A146B6BBB063 (offer_variation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
